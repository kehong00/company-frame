...
public enum  BaseResponseCodeImpl implements IResponseCode {
    ...
    ACCOUNT_HAS_DELETE_ERROR(4010002,"账户已被删除"),
    TOKEN_NOT_NULL(4010003,"认证凭证不能为空，请重新登录"),
    TOKEN_ERROR(4010004,"身份认证异常，请重新登录"),
    TOKEN_PAST_DUE(4010005,"身份过期"),
    ...
    DEPT_NOT_FOUNT_ERROR(500006,"部门信息错误"),
